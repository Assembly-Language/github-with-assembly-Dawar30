...
;Display the sum.
;Display how many total even numbers.

include irvine32.inc 
.data
message1 db 'total even numbers:  ',0
message db 'Sum of even values is:  ',0
...
next: 
 test WORD PTR [esi],1h                                ;Testing values with 0000 0000 0000 0001 or an odd number
 pushfd                                                ;pushing registers for saving their states
 add esi,TYPE array                                    ;moving to next index of array
 popfd 
 jz sum                                                ;if zero flag ON Jump to SUM label
 again:
 loop next
jmp display                                            ;For directly moving to display
 
sum:
inc count                                              ;To count number of even numbers in array
